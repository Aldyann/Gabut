...
module.exports = {
  name: "filter",
  description: "Mengatur Audio - Effects",
  aliases: ["fi"],
  cooldown: 3,
  edesc: `Ketik Perintah ini untuk mengubah efek audio saat ini - style \nPenggunaan: ${PREFIX}filter <Filtertype>`,
...
async execute(message, args, client) {
    ...
    if (!message.member.voice.channel)
      return attentionembed(message, "Silakan bergabung dengan Saluran Suara terlebih dahulu")
    ...
    switch (args[0]) {
      ...
      default:
        ...
        .setColor("#1c00c2")
        .setTitle("Bukan Filter yang valid, gunakan salah satunya:")
        .setDescription(`
        \`bassboost\`
        \`8D\`
        \`vaporwave\`
    ...
    try {
      ...
      message.channel.send(new MessageEmbed()
      .setColor("#000035")
      .setAuthor("Dipilih: " + args[0])).then(msg =>{
